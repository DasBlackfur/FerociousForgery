...
public class FormingAnvilScreenHandler extends ScreenHandler {
    ...
    public FormingAnvilScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
